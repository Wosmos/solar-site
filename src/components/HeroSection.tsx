    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-600">
        ...
        <div className="absolute inset-0 opacity-10" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Crect width='11' height='11'/%3E%3Crect x='20' width='11' height='11'/%3E%3Crect x='40' width='11' height='11'/%3E%3Crect y='20' width='11' height='11'/%3E%3Crect x='20' y='20' width='11' height='11'/%3E%3Crect x='40' y='20' width='11' height='11'/%3E%3Crect y='40' width='11' height='11'/%3E%3Crect x='20' y='40' width='11' height='11'/%3E%3Crect x='40' y='40' width='11' height='11'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
        }}></div>
      </div>
