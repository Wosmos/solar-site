...
- Secondary: 45 95% 50% (Solar energy gold)
- Accent: 120 40% 45% (Sustainable green)
- Neutral: 220 15% 95% (Light backgrounds)

**Dark Mode:**
- Primary: 220 75% 65% (Lighter blue for contrast)
- Secondary: 45 90% 60% (Warmer gold)
- Accent: 120 35% 55% (Muted green)
...
- **Technical specs**: Inter Medium for project details

### Layout System
Tailwind spacing units: 4, 8, 16, 24 for consistent rhythm
- Margins: m-8, m-16
...
## Visual Treatment
**Professional B2B Focus**: Clean, technical aesthetic emphasizing expertise and scale
**Solar Industry Elements**: Subtle solar panel patterns, clean energy imagery
...
- **Office Locations**: Dubai and India office imagery for contact pages

**Critical**: Use blurred backgrounds for outline buttons overlaid on hero images to maintain readability and professionalism.